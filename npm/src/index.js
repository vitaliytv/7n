...
Команди:
  ...
  ch              Створити change-файл(и) у .changes/ кожного зачепленого воркспейса (ws визначається авто за git, --path звужує до одного; без --message опис генерує omlx; bump=minor, section=Changed за замовч.)
