...
Команди:
  ...
  ch              Створити change-файл(и) у .changes/ кожного зачепленого воркспейса (ws визначається авто за git; без --message опис генерує omlx; bump=minor, section=Changed за замовч.)
